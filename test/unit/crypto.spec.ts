/**
 * crypto.ts 单元测试（Web Crypto API 版本）
 *
...
describe('encrypt / decrypt', () => {
  ...
  it('长文本可以正常加解密（模拟 B站 Cookie）', async () => {
  ...
  it('相同的明文两次加密结果不同（随机 IV + Salt）', async () => {
